...
KATEGORI_MAP = {
    ...
    # Pilav / Makarna / Börek
    "Bolonez Soslu Makarna": "pilav",
    "Bulgur Pilavı": "pilav",
    "Cevizli Erişte": "pilav",
    "Dom. Bulgur Pilavı": "pilav",
    "Erişte": "pilav",
    "Fesleğen Soslu Makarna": "pilav",
    "Fırın Makarna": "pilav",
    "Hav. Pirinç Pilavı": "pilav",
    "Kuskus Pilavı": "pilav",
    "Mıs. Pirinç Pilavı": "pilav",
    "Mısırlı Pirinç Pilavı": "pilav",
    "Nap. Soslu Makarna": "pilav",
    "Napoliten Soslu Makarna": "pilav",
    "Patatesli Gül Böreği": "pilav",
    "Patatesli Kol Böreği": "pilav",
    "Peynirli Gül Böreği": "pilav",
    "Pilav Üstü Dana Tandır": "pilav",
    "Pirinç Pilavı": "pilav",
    "Sebzeli Makarna": "pilav",
    "Soslu Makarna": "pilav",
    "Su Böreği": "pilav",
    "Yeşil Mercimekli Bulgur Pilavı": "pilav",
    "Yoğurtlu Mantı Makarna": "pilav",
    "İç Pilav": "pilav",
    "Şeh Pirinç Pilavı": "pilav",
    "Şeh. Bulgur Pilavı": "pilav",
    "Şeh. Pirinç Pilavı": "pilav",
    "Şehriye Pilavı": "pilav",
    "Şehriyeli Bulgur Pilavı": "pilav",
    "Şehriyeli Kuskus Pilavı": "pilav",
    "Şehriyeli Pirinç Pilavı": "pilav",
    # Tatlılar
    "Baklava": "tatli",
    ...
    with open(MENU_CSV, "r", encoding="utf-8") as f:
        ...
        for row in reader:
            ...
            menu = Menu(
                ...
                pilav=row.get("pilav_makarna", "").strip() or None,
